...
/******************************************************************************
*
* 폴트 트램폴린 : 예외 진입 시 사용된 스택(MSP/PSP)을 골라 R0 로 넘긴다.
* EXC_RETURN(LR) 의 bit2 가 0 이면 MSP, 1 이면 PSP 를 쓴 것이다.
* 이렇게 넘겨야 *_Handler_C() 가 스택 프레임에서 R0-R3/R12/LR/PC/PSR 을 꺼낼 수 있다.
*
******************************************************************************/
